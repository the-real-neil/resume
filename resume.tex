...
Experienced platform/systems software engineer with a demonstrated history
working in the industrial automation industry. Skilled in the design,
implementation, deployment, troubleshooting, and administration of Linux
software systems. Adept at taming the sprawling chaos of the full modern
software stack.
...
\item
  Lucas, M. W. (2024).
  \textit{Run Your Own Mail Server}.
  Grosse Pointe Woods, MI:\ Tilted Windmill Press.
\item
  Lucas, M. W. (2023).
  \textit{OpenBSD Mastery: Filesystems}.
  Grosse Pointe Woods, MI:\ Tilted Windmill Press.
\item
  Lucas, M. W. (2022).
  \textit{DNSSEC Mastery, 2nd Edition}.
  Grosse Pointe Woods, MI:\ Tilted Windmill Press.
\item
  Lucas, M. W. (2020).
  \textit{SNMP Mastery}.

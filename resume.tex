...
\subsubsection*{\textsc{Principal Software Dev Ops Engineer} | Medtronic plc \hfill 2024 January --- current}
...
\item
  ...
  systems (GIT), including branching and merging strategies.
\item
...
\item
  ...
  applications via configuration management such as Ansible and Terraform.
\item
  Debuged build issues for a cross-compiled, multi-target architecture based
  embedded product.
\item
...
\hiddenText{\input{resume.hidden.txt}}
